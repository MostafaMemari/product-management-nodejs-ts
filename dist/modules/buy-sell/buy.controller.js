...
const buy_dto_1 = require("./buy.dto");
const class_transformer_1 = require("class-transformer");
const http_status_codes_1 = require("http-status-codes");
const buy_service_1 = __importDefault(require("./buy.service"));
const color_message_1 = require("./color.message");
const auto_bind_1 = __importDefault(require("auto-bind"));
const public_types_1 = require("../../types/public.types");
class ColorController {
    constructor() {
        this.service = buy_service_1.default;
        (0, auto_bind_1.default)(this);
    }
    async create(req, res, next) {
        try {
            const colorDto = (0, class_transformer_1.plainToClass)(buy_dto_1.ColorDTO, req.body, { excludeExtraneousValues: true });
    ...
    async update(req, res, next) {
        try {
            ...
            const colorDto = (0, class_transformer_1.plainToClass)(buy_dto_1.ColorUpdateDTO, req.body, {
