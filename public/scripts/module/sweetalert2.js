...
!(function (t, e) {
  ...
  var y = {},
      ...
      return new Promise(function (e) {
        ...
        (y.restoreFocusTimeout = setTimeout(function () {
          y.previousActiveElement instanceof HTMLElement
            ? (y.previousActiveElement.focus(), (y.previousActiveElement = null))
    ...
    ot = function (t, n, o) {
      if (
        ...
        if ("string" != typeof n.customClass[o] && !n.customClass[o].forEach)
          return void B(
            "Invalid type of customClass.".concat(o, '! Expected string or iterable object, got "').concat(e(n.customClass[o]), '"')
          );
    ...
    it = function (t, e) {
      ...
      switch (e) {
        ...
        case "radio":
          return (
            t.querySelector(".".concat(A.popup, " > .").concat(A.radio, " input:checked")) ||
            t.querySelector(".".concat(A.popup, " > .").concat(A.radio, " input:first-child"))
          );
        case "range":
    ...
    kt = function (t) {
      var e,
        n =
          !!(e = I()) &&
          (e.remove(), ut([document.documentElement, document.body], [A["no-backdrop"], A["toast-shown"], A["has-column"]]), !0);
    ...
    xt = function (t, e) {
      ...
      n &&
        o &&
        (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? dt(n) : ft(n),
        ot(n, e, "actions"),
        (function (t, e, n) {
          var o = z(),
            i = K(),
          ...
          St(o, "confirm", n),
            ...
            (function (t, e, n, o) {
              ...
              ct([t, e, n], A.styled),
                o.confirmButtonColor && ((t.style.backgroundColor = o.confirmButtonColor), ct(t, A["default-outline"]));
  ...
  var Lt = { innerParams: new WeakMap(), domCache: new WeakMap() },
    ...
    Rt = function (t, n) {
      ["string", "number"].includes(e(n))
        ? (t.value = "".concat(n))
        : M(n) || B('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(e(n), '"'));
    },
    _t = {};
  (_t.text =
    _t.email =
  ...
  var Nt = function (t, e) {
      ...
      n &&
        ...
        e.html ? (Et(e.html, n), dt(n, "block")) : e.text ? ((n.textContent = e.text), dt(n, "block")) : ft(n),
        (function (t, e) {
          var n = q();
          if (n) {
    ...
    Yt = function (t, e) {
      ...
      (t.className = "".concat(A.popup, " ").concat(vt(t) ? n.popup : "")),
        e.toast ? (ct([document.documentElement, document.body], A["toast-shown"]), ct(t, A.toast)) : ct(t, A.modal),
        ot(t, e, "popup"),
          ...
          if (o) {
            ...
            if (e.icon || e.iconHtml) {
              if (e.icon && -1 === Object.keys(k).indexOf(e.icon))
                return (
                  T('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')), void ft(o)
                );
    ...
    ue = { swalPromiseResolve: new WeakMap(), swalPromiseReject: new WeakMap() },
    se = function () {
    ...
    fe = function (t) {
      ...
      return (
        ...
        !pe(t) &&
        !me(t) &&
        (e === n || (!gt(n) && e instanceof HTMLElement && "INPUT" !== e.tagName && "TEXTAREA" !== e.tagName && (!gt(o) || !o.contains(e))))
      );
    },
    pe = function (t) {
    ...
    ve = function (t) {
      null === he &&
        ...
        ((he = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"))),
  ...
  function ge(t, e, n, o) {
    tt()
      ...
      : (w(n).then(function () {
        ...
        Qt(y)),
      le ? (e.setAttribute("style", "display:none !important"), e.removeAttribute("class"), (e.innerHTML = "")) : e.remove(),
      Q() &&
        (null !== he && ((document.body.style.paddingRight = "".concat(he, "px")), (he = null)),
        (function () {
        ...
        se()),
      ut([document.documentElement, document.body], [A.shown, A["height-auto"], A["no-backdrop"], A["toast-shown"]]);
  }
  function be(t) {
    t = Ae(t);
  ...
  var Ce = function (t) {
    ...
    Te = function (t, e) {
      ...
      n &&
        ...
        (!e && vt(z()) && (e = z()),
        dt(n),
        e && (ft(e), o.setAttribute("data-button-to-replace", e.className), n.insertBefore(o, e)),
        ct([t, n], A.loading));
    },
    xe = function (t) {
    ...
    Le = function (t, n) {
      ...
      if (o) {
        ...
        L(n.inputOptions) || M(n.inputOptions)
          ...
          ? i(n.inputOptions)
          : T("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(e(n.inputOptions)));
      }
    },
    je = function (t, e) {
      var n = t.getInput();
  ...
  function Ke(t, e) {
    var n = q();
    if (n && t)
      if ("radio" === t.type) for (var o = n.querySelectorAll('[name="'.concat(A.radio, '"]')), i = 0; i < o.length; i++) o[i].disabled = e;
      else t.disabled = e;
  }
  function Ye() {
  ...
  function Xe(t) {
    ...
    et(e.validationMessage, t),
      ...
      n.customClass && n.customClass.validationMessage && ct(e.validationMessage, n.customClass.validationMessage),
  ...
  function fn() {
    ...
    e
      ? (t.popup && y.swalCloseEventFinishedCallback && (y.swalCloseEventFinishedCallback(), delete y.swalCloseEventFinishedCallback),
  ...
  var xn,
    ...
    On = Object.freeze({
          ...
          "object" !== e(t[0]) || kn(t[0])
            ? ["title", "html", "icon"].forEach(function (o, i) {
                ...
                "string" == typeof r || kn(r)
                  ? (n[o] = r)
                  : void 0 !== r && T("Unexpected type of ".concat(o, '! Expected "string" or "Element", got ').concat(e(r)));
              })
            : Object.assign(n, t[0]),
          n
        );
      ...
      bindClickHandler: function () {
        (Tn[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this),
    ...
    Fn = function (t) {
      ...
      Kn(e, n, t),
        ...
        tt() || y.previousActiveElement || (y.previousActiveElement = document.activeElement),
    ...
    Kn = function (t, e, n) {
      ct(t, n.showClass.backdrop),
        ...
        n.heightAuto && n.backdrop && !n.toast && ct([document.documentElement, document.body], A["height-auto"]);
    },
    Yn = {
      email: function (t, e) {
  ...
  var $n = new WeakMap(),
    ...
    no = function (t, e) {
      return e.focusDeny && vt(t.denyButton)
        ...
        : !(!e.focusConfirm || !vt(t.confirmButton)) && (t.confirmButton.focus(), !0);
    },
    oo = function () {
