...
!(function (t, e) {
        ...
        if (
          (r
            ? ((M = S),
              "inner" === k &&
                (f =
                  x === _ - 1 ? (this.options.reverse ? "left" : "right") : 0 === x ? (this.options.reverse ? "right" : "left") : "center"),
              (O =
                "top" === s
                  ? "near" === c || 0 !== m
                    ? -C * D + D / 2
  ...
  function Sn(t) {
    return (
      fe() && "string" == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t
    );
  }
  const Pn = {},
    Dn = (t) => {
  ...
  class bo extends Js {
    ...
    buildTicks() {
      ...
      const n = (function (t, e) {
        ...
        for (
          b &&
          (u && M !== a ? (i.push({ value: a }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, mo(a, y, t)) && D++) : M < a && D++);
          D < k;
          ++D
        ) {
    ...
    s &&
      ...
      (function (t, e) {
        ...
        t.save(),
          "x" === l &&
            o !== n &&
            (ua(t, s, a.top), fa(t, { line: i, target: s, color: n, scale: r, property: l }), t.restore(), t.save(), ua(t, s, a.bottom));
  ...
  function Oa(t, e) {
    ...
    if (
      ((x += t.beforeBody.length + t.afterBody.length), d && (m += d * h.lineHeight + (d - 1) * e.titleSpacing + e.titleMarginBottom), x)
    ) {
